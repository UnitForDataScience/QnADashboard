...
path = os.path.join(os.path.dirname(__file__), './', 'bio')
stopwords = set(
    stopwords.words('english') + list(punctuation) + ['TITLE', 'NRC', 'enclosure',
                                                     'nuclear', 'arkansas', 'inspection',
                                                     'report', 'docu', 'energy', 'nrc', 'DOCUMENT', 'CONTAINS',
                                                     'SAFEGUARDS', 'INFORMATION'] + list(
